...
namespace Simple
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var myServices = new ServiceCollection().AddTransient<DependencyOne>();
            var configurationAdapter = factory.CreateBuilder(myServices);
            ...
            var service = serviceProvider.GetRequiredService<DependencyOne>();
