...
namespace Simple
{
    ...
    public class PrintMessages : IPrintMessages
    {
        public string Print() => "JackSlater .. !!!!";
    }
    public class Program
    {
        public static async Task Main(string[] args) =>
           await Host.CreateDefaultBuilder(args)
                   ...
                   .ConfigureContainer<ContainerBuilder>(builder => builder.RegisterType<PrintMessages>().As<IPrintMessages>())
          .Build()
          .RunAsync()
          ;
    }
